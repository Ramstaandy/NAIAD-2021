...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_pid_main" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#194fe71e#;
   pragma Export (C, u00001, "pid_mainB");
