...
package body ada_main is
   ...
   E194 : Short_Integer; pragma Import (Ada, E194, "exception_handling_E");
   E198 : Short_Integer; pragma Import (Ada, E198, "exception_handling__test_data_E");
   E202 : Short_Integer; pragma Import (Ada, E202, "exception_handling__test_data__tests_E");
   E204 : Short_Integer; pragma Import (Ada, E204, "exception_handling__test_data__tests__suite_E");
   ...
   begin
      declare
         procedure F1;
         pragma Import (Ada, F1, "exception_handling__test_data__tests__suite__finalize_body");
      begin
         E204 := E204 - 1;
         F1;
      end;
      ...
      declare
         procedure F2;
         pragma Import (Ada, F2, "exception_handling__test_data__tests__finalize_spec");
      begin
         F2;
      end;
      E198 := E198 - 1;
      declare
         procedure F3;
         pragma Import (Ada, F3, "exception_handling__test_data__finalize_spec");
      begin
         F3;
      end;
      E083 := E083 - 1;
   ...
   begin
      ...
      E194 := E194 + 1;
      Exception_Handling.Test_Data'Elab_Spec;
      E198 := E198 + 1;
      Exception_Handling.Test_Data.Tests'Elab_Spec;
      E202 := E202 + 1;
      Exception_Handling.Test_Data.Tests.Suite'Elab_Body;
      E204 := E204 + 1;
...
--  BEGIN Object file/option list
   --   /home/evr/git/naiad-auv-software/src/lib/exception_handling/obj/exception_handling.o
   --   /home/evr/git/naiad-auv-software/src/lib/exception_handling/obj/gnattest/harness/exception_handling-test_data.o
   --   /home/evr/git/naiad-auv-software/src/lib/exception_handling/obj/gnattest/harness/gnattest_generated.o
   --   /home/evr/git/naiad-auv-software/src/lib/exception_handling/obj/gnattest/harness/exception_handling-test_data-tests.o
   --   /home/evr/git/naiad-auv-software/src/lib/exception_handling/obj/gnattest/harness/exception_handling-test_data-tests-suite.o
   --   /home/evr/git/naiad-auv-software/src/lib/exception_handling/obj/gnattest/harness/gnattest_main_suite.o
   --   /home/evr/git/naiad-auv-software/src/lib/exception_handling/obj/gnattest/harness/test_runner.o
   --   -L/home/evr/git/naiad-auv-software/src/lib/exception_handling/obj/gnattest/harness/
   --   -L/home/evr/git/naiad-auv-software/src/lib/exception_handling/obj/gnattest/harness/
   --   -L/usr/gnat/lib/aunit/native-full/
   --   -L/home/evr/git/naiad-auv-software/src/lib/exception_handling/obj/
