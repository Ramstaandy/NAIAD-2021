...
package ada_main is
   ...
   u00191 : constant Version_32 := 16#899aad10#;
   ...
   u00193 : constant Version_32 := 16#f3e157e4#;
   pragma Export (C, u00193, "exception_handlingB");
   u00194 : constant Version_32 := 16#edb42e3f#;
   pragma Export (C, u00194, "exception_handlingS");
   u00195 : constant Version_32 := 16#39591e91#;
   pragma Export (C, u00195, "system__concat_2B");
   u00196 : constant Version_32 := 16#6bf463ed#;
   pragma Export (C, u00196, "system__concat_2S");
   u00197 : constant Version_32 := 16#aecbbe11#;
   pragma Export (C, u00197, "exception_handling__test_dataB");
   u00198 : constant Version_32 := 16#1fee7c45#;
   pragma Export (C, u00198, "exception_handling__test_dataS");
   ...
   u00201 : constant Version_32 := 16#40e97a5c#;
   pragma Export (C, u00201, "exception_handling__test_data__testsB");
   u00202 : constant Version_32 := 16#c320e577#;
   pragma Export (C, u00202, "exception_handling__test_data__testsS");
   u00203 : constant Version_32 := 16#4d1dbe52#;
   pragma Export (C, u00203, "exception_handling__test_data__tests__suiteB");
   u00204 : constant Version_32 := 16#372c550d#;
   pragma Export (C, u00204, "exception_handling__test_data__tests__suiteS");
   ...
   --  exception_handling.test_data%s
   --  exception_handling.test_data%b
   --  gnattest_generated%s
   --  exception_handling.test_data.tests%s
   --  exception_handling.test_data.tests%b
   --  exception_handling.test_data.tests.suite%s
   --  exception_handling.test_data.tests.suite%b
